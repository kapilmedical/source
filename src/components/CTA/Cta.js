...
const CTA = () => (
  <div className='Section u-wrapper text-center'>
    <h3 className='u-title'>Ready to get started?</h3>
    <p className='u-subtitle'>Reach for more info, queries or anything related to medicines and we'll be glad to help you..</p>

    <div className='Split'>
      <Button primary onClick={() => {}}>Call - 83020-32000 </Button>
      <Button secondary onClick={() => {}}>Email - care@kapilmedial.com </Button>
